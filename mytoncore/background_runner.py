...
class BackgroundRunner:
    ...
    def _post_complaints(self):
        self._local.add_log("start post_complaints function", "debug")
        if not self._local.db.get("isPosting"):
            return
        config32 = self._ton.get_config_32()
        end = config32.end_work_time
        ts = get_timestamp()
    ...
    def run(self):
        ...
        self._local.start_cycle(self._post_complaints, sec=600)
